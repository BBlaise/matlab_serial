...
serial_config.n_tx = 1;           % length of outgoing vector
serial_config.n_rx = 0;           % length of incoming vector
...
% COM PORT
serial_config.com_port = 'COM9';        % COM port on Windows
...
% serial_config.terminator = '\n';
% serial_onfig.terminator = '\r\n';
...
% % Transmitting/Outbound Data Type
