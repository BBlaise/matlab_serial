function uart_config = configureSerialPort()
...
% COM PORT
uart_config.com_port = 'COM5';        % COM port on Windows
% uart_config.com_port = 'COM4';        % COM port on Windows 
...
uart_config.terminator = 'LF';
% uart_config.terminator = 'CR/LF';
% uart_config.terminator = 'CR';

% % Delimeter
uart_config.delimeter = ',';
% uart_config.delimeter = '';       % no delimeter
% uart_config.delimeter = ' ';      % space
% uart_config.delimeter = '\t';     % tab
% uart_config.delimeter = '.';
% uart_config.delimeter = '-';
...
uart_config.rx_data_type = 'int16';       % i.e. Arduino Uno
